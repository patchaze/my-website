...
const destinationOverrides: Record<string, DestinationOverride> = {
  lithuania: {
    ...
    articleHtml: `
      ...
      <p>Lithuania also fits well inside a broader first-Europe plan because it keeps logistics readable. You can combine it with another Schengen country and still keep the route believable for both your own energy and your visa paperwork. If you want the trip to stay efficient, use our <a href="/blog/10-day-europe-itinerary-from-the-philippines/">10-day Europe itinerary from the Philippines</a> as a pacing reference before you lock your bookings.</p>
  ...
  sweden: {
    ...
    articleHtml: `
      ...
      <p>If Sweden is your main destination by number of nights, build your application around Sweden. If it is just one stop on a broader trip, apply through the country that is actually the main destination. We explain that rule in plain language in our <a href="/blog/schengen-visa-requirements-philippine-passport-holders/">Philippines Schengen visa guide</a>.</p>
      ...
      <p>If Sweden is showing up in your Search Console already, the next move is to support this page with more specific intent-matching content. Start with our <a href="/blog/sweden-itinerary-from-the-philippines/">Sweden itinerary from the Philippines</a> for route planning and <a href="/blog/is-sweden-worth-it-for-filipino-travelers/">Sweden cost reality check for Filipino travelers</a> for budget framing.</p>
    `
  },
  bulgaria: {
    ...
    articleHtml: `
      ...
      <p>If you are applying from the Philippines, use our <a href="/blog/schengen-visa-requirements-philippine-passport-holders/">Philippines Schengen guide</a> together with the <a href="/blog/schengen-document-checklist/">document checklist</a>. Those two pages will save you more time than generic visa forums.</p>
      ...
      <p>That is where it pairs well with our broader planning content. If you want a first Europe route with better budget control, compare this page with our <a href="/blog/10-day-europe-itinerary-from-the-philippines/">10-day Europe itinerary from the Philippines</a> and our <a href="/blog/europe-trip-budget/">Europe trip budget guide</a> before booking anything irreversible.</p>
