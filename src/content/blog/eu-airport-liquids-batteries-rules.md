---
title: "EU Airport Security Packing Rules: Liquids, Power Banks, and Exceptions (Plain English)"
...
| Device | Typical Battery | Notes |
|--------|----------------|-------|
| Phone power bank (10,000 mAh) | ~37 Wh | Usually fine |
| Laptop power bank (20,000 mAh) | ~74 Wh | Usually fine |
| Large power bank (30,000+ mAh) | 100+ Wh | Check airline rules |
...
Generally yes for solid food. Spreads, liquids, and sauces fall under the liquids rule.

**What about e-cigarettes and vapes?**
These contain lithium batteries and must be in carry-on, not checked baggage. Check airline-specific rules.

**Do rules differ between EU airports?**
The base EU rules are consistent, but individual airports may have additional screening procedures or updated technology that changes the process slightly.

---

*This post may contain affiliate links.*

**If you're unsure about medication travel logic for your route**, our [Travel Health Consult](/services/travel-health-consult/) covers flying with medications and devices (educational guidance). Or read our [full Europe Packing List](/blog/europe-packing-list/) for everything else you need to bring.
