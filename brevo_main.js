  ...
  var e = {
      ...
      20319: (e, t, n) => {
        ...
        const o = /^[0-9]{5,15}$/,
          ...
          u = /^(([0-9]*)|(([0-9]*)\.([0-9]*)))$/,
          _ = window.LOCALE || "en",
          l = ["br", "de", "en", "es", "fr", "it", "pt"].includes(_) ? _ : "en",
          c = n(99418)(`./sendinblue-form.${l}.json`),
          {
            pickaday: {
              month: {
                january: m,
        ...
        const R = Array.from(document.getElementsByClassName("sib-input")),
          I = Array.from(document.getElementsByClassName("sib-sms-input"));
        R.forEach((e) => {
          e.errorMessage = window.REQUIRED_ERROR_MESSAGE;
          let t = null;
            ...
            "date" === r.dataset.type &&
              new (a())({
                i18n: {
                  ...
                  months: [m, h, f, y, p, M, L, Y, g, v, k, b],
                  weekdays: [w, D, T, S, j, x, H],
                  weekdaysShort: [O, E, P, A, F, W, N],
                },
                field: r,
            ...
            try {
              !(function (e, t) {
                ...
                if (
                  ...
                  const t =
                    n.getElementsByClassName("g-recaptcha-v3").length > 0;
                  (window.grecaptcha && !t && window.grecaptcha.reset(),
